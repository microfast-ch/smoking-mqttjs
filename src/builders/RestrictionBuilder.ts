...
export class RestrictionBuilder {
    ...
    /**
     * Add an array of permissions to the restriction. Can be called several times.
     * @param values the array of permissions. Use {@type PermissionBuilder} to build permissions.
     */
    public withPermissions(values: Array<Permission>): RestrictionBuilder {
        this.permissions.push.apply(this.permissions, values);
        return this;
    }
